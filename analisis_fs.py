...
def generacion_analitica_descriptiva():
            ...
            for mh in mhs:
                for clasificador in clasificadores:
                    for metric in metricas:
                        ...
                        maximo = data['value'].max()
                        media = data['value'].mean()
                        desviacion_estandar = data['value'].std()
    ...
    analitica_descriptiva_df.to_csv(f'./resultados/data/rendimiento/analitica_descriptiva.csv', index=False)
    print(analitica_descriptiva_df)
