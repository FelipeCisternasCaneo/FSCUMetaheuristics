...
clasificadores = ['KNN', 'RandomForest', 'LightGBM', 'SVM', 'LogisticRegression', 'NaiveBayes', 'DecisionTree']
...
for clasificador in clasificadores:
    ...
    if clasificador == 'KNN':
        ...
        model = LGBMClassifier(random_state=42, importance_type=”gain”, verbose=-1)
